...
public class CoopProspect implements Serializable {
	...
	public CoopProspect(Integer prospectNo, String lastName, String firstName, Character gender, String cityMun, boolean lengthOfStay, String nationality, Date prosDate) {
		this.prospectNo = prospectNo;
